 ...
 *
 * As áreas são `numeric(14,2)`, e há restrição de não negatividade em cada uma: a regra da
 * soma vive na entidade, mas área negativa é dado impossível, e o banco é o último lugar
 * onde isso pode ser barrado.
 *
 * `estado` e `produtor_id` recebem índice porque o painel agrupa pelo primeiro e o cadastro
 * do Produtor filtra pelo segundo. Ver o registro 0004.
 */
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE "propriedades" (
        ...
        "area_total" numeric(14,2) NOT NULL,
        "area_agricultavel" numeric(14,2) NOT NULL,
        "area_de_vegetacao" numeric(14,2) NOT NULL,
